...
public class RenderEggTNTPrimed extends Render {
	...
	public void doRender(Entity e, double x, double y, double z, float par8, float par9) {
		...
		var10 = (1.0F - (entityEggTNT.fuse - par9 + 1.0F) / 100.0F) * 0.8F;
		loadTexture("/steve4448/images/tntsheet.png");
		blockRenderer.renderBlockAsItem(ExpandedTNT.blockEggTNT, 0, entityEggTNT.getBrightness(par9));
		...
		if(entityEggTNT.fuse / 5 % 2 == 0) {
			...
			blockRenderer.renderBlockAsItem(ExpandedTNT.blockEggTNT, 0, 1.0F);
