...
public class ExpandedTNT {
	public static final int TNT_TEXTURE_TOP = 16, TNT_TEXTURE_BOTTOM = 17,
			TNT_ARROWS_SIDES = 0, TNT_EGGS_SIDES = 1, TNT_TNT_SIDES = 2,
			TNT_TNT_TNT_SIDES = 3;

	public static int blockArrowsTNTID, blockEggTNTID, blockTNTTNTID,
			blockTNTTNTNTTID;

	public static boolean blockArrowsTNTEnabled, blockEggTNTEnabled,
			blockTNTTNTEnabled, blockTNTTNTTNTEnabled;

	public static Block blockArrowsTNT, blockEggTNT, blockTNTTNT,
			blockTNTTNTTNT;
