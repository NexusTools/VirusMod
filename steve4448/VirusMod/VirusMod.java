...
@Mod(modid = "VirusMod", name = "Virus Mod", version = "0.3.3")
@NetworkMod(clientSideRequired = true, serverSideRequired = false)
public class VirusMod {
	public static final String[] virusBlockNames = { 
		"Eater Virus", "Replacer Virus", "Tool Virus", "Logic Virus?"
	};
	...
	public void load(FMLInitializationEvent IEvent) {
		...
		try {
			virusEaterAnim = new ModTextureAnimation(0, 1, "/steve4448/VirusMod/images/virussheet.png", TextureFXManager.instance().loadImageFromTexturePack(Minecraft.getMinecraft().renderEngine, "/steve4448/VirusMod/anim/eatervirusanim.png"), 2);
